import { getUnemploymentRate } from "../lib/actions";
const header =
...
export default async function Home() {
  const unemploymentData = await getUnemploymentRate();
  ...
  return (
    <div className='flex-1 flex flex-col items-center justify-start sm:p-20 font-[family-name:var(--font-geist-sans)]'>
      <h3 className='font-extrabold sm:text-4xl sm:mb-20'>Unemployment Rate</h3>
